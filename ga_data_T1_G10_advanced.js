...
/* Term 1 · AY 2026-27 · Grade 10 Advanced (ENG.07 · Stage 7) · Mourad Mekki Teacher Toolkit */
/* Unit 1 'A Picture of Health' (1 CCG: Question Tags; 3 teacher extensions) + Unit 2 'Infotainment' (1 CCG: Historic Present; 3 teacher extensions). */
/* 8 lessons / 240 questions. CCG names only 2 grammar items (both without a number → 'CCG' pills); the other 6 lessons are unit-themed Extensions. No invented G-codes. */
/* Stage-based IDs (t1s7_) so the byte-identical Grade 11 General (ENG.07) twin can reuse the lesson bank. */
GA.register(
{
  "term": "T1-2627",
  ...
  "source": "CCG Grade 10 Advanced — Term 1 (AY 2026–27) · Units 1 (A Picture of Health) & 2 (Infotainment). The CCG names two grammar items (Question Tags, Historic Present), each listed without a number → 'CCG' pills; the remaining six lessons are teacher Extensions themed to genuine CCG content in each unit. 8 lessons / 240 questions.",
  "chapters": [
    {
      "id": "ch1",
