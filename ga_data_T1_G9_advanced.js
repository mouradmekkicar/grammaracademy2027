...
/* Term 1 · AY 2026-27 · Grade 9 Advanced (ENG.06 · Stage 6) · Mourad Mekki Teacher Toolkit */
/* TWIN of Grade 10 General: Grade 9 Advanced sits on the same ENG.06 stage, so this file reuses the t1s6_ lesson bank byte-for-byte; only grade/stream metadata differs. */
...
GA.register(
{
  ...
  "source": "MoE Comprehensive Curriculum Guide — English Language, Grade 9 Advanced, Term 1 (ENG.06 · Stage 6). Grade 9 Advanced follows the same ENG.06 stage as Grade 10 General, so the lesson bank is shared. Grammar items are named in the CCG scope & sequence and Unit Overview without numbered G-codes, so all eight render as 'CCG' pills.",
  "chapters": [
    {
      "id": "ch1",
