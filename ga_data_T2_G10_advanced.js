...
/* Term 2 · AY 2025-26 · Grade 10 Advanced (ENG.07) · Mourad Mekki Teacher Toolkit */
...
GA.register(
{
  ...
  "source": "CCG Grade 10 Advanced — Term 2 · Chapters 3 (Let's Hang Out!) & 4 (Get Up, Go Out, Get Moving!). CCG grammar: G.2.2, G.4.3, G.1.3; the remaining five lessons are teacher extensions (marked 'Extension').",
  "chapters": [
    {
      "id": "ch3",
